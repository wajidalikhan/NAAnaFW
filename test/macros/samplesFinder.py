...
parser.add_option('-o', '--outputDir',   dest='outdir',  type='string',     default = './',      help='Directory to create the samples folder')
...
parser.add_option('-p','--path',      dest='path',     type='string',     default = '/pnfs/lcg.cscs.ch/cms/trivcat/store/user/oiorio/ttDM/samples/2016/Oct/',    help='local path for the samples, if file name is  specified')
...
samplesAndPaths = {
    "ST_t-channel_top":"/pnfs/lcg.cscs.ch/cms/trivcat/store/user/oiorio/ttDM/samples/2016/Oct/",
    "ST_t-channel_antitop":"/pnfs/lcg.cscs.ch/cms/trivcat/store/user/oiorio/ttDM/samples/2016/Oct/",
    "TT_Tune":"/pnfs/lcg.cscs.ch/cms/trivcat/store/user/oiorio/ttDM/samples/2016/Oct/",
    "ST_tW_top":"/pnfs/lcg.cscs.ch/cms/trivcat/store/user/oiorio/ttDM/samples/2016/Oct/",
    "ST_tW_antitop":"/pnfs/lcg.cscs.ch/cms/trivcat/store/user/oiorio/ttDM/samples/2016/Oct/",
    "ST_s-channel":"/pnfs/lcg.cscs.ch/cms/trivcat/store/user/oiorio/ttDM/samples/2016/Oct/",
    "WJetsToLNu":"/pnfs/lcg.cscs.ch/cms/trivcat/store/user/oiorio/ttDM/samples/2016/Oct/",
    "DYJetsToLL":"/pnfs/lcg.cscs.ch/cms/trivcat/store/user/oiorio/ttDM/samples/2016/Oct/",
    }
...
os.system("mkdir "+outDir+"/samples")
os.system("rm "+outDir+"/samples/listAllSamples.py")
...
#    outputList = []
    ...
    if not opt.dryrun:
        printFilesInList(outputListJES, "/pnfs/lcg.cscs.ch/cms/trivcat/", sample,"./samples/","w",verbose=(opt.verbose>1))
        printFilesInList(outputListJES, "/pnfs/lcg.cscs.ch/cms/trivcat/", sample,"./samples/","a",verbose=(opt.verbose>1))
