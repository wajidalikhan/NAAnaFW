...
#    outputList = []
    ...
    if not opt.dryrun:
        printFilesInList(outputListJES, "/pnfs/lcg.cscs.ch/cms/trivcat/", sample,"./trees/","w",verbose=opt.verbose>1)
        printFilesInList(outputListJES, "/pnfs/lcg.cscs.ch/cms/trivcat/", sample,"./trees/","a",verbose=opt.verbose>1)
