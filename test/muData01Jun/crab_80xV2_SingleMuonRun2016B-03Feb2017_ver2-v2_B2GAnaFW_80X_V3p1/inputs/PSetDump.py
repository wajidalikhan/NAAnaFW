...
process.DMTreesDumper = cms.EDAnalyzer("DMAnalysisTreeMaker",
    ...
    JECVersion = cms.string('Spring16_23Sep2016BCDV2'),
    ...
    channelInfo = cms.PSet(
        ...
        SingleElTriggers = cms.vstring('HLT_Ele27_WPTight_Gsf', 
            'HLT_Ele32_eta2p1_WPTight_Gsf', 
            'HLT_Ele27_WPTight_Gsf_v0', 
            ...
            'HLT_Ele32_eta2p1_WPTight_Gsf_v0', 
        ...
        SingleMuTriggers = cms.vstring('HLT_IsoMu22', 
            'HLT_IsoTkMu22', 
            'HLT_IsoMu22_v0', 
            'HLT_IsoMu22_v1', 
            'HLT_IsoMu22_v2', 
    ...
    usePrunedGenParticles = cms.untracked.bool(False),
