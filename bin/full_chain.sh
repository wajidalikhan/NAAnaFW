...
python script_rename.py -s ~oiorio/public/xWajid/files/trees/dec19/ -d files/renamed
...
#python merge_res.py -l ./res/ -P ST,TT,VJ,VV --rm True
#python merge_res.py -l ./res -P SingleMuon -c "muon,muonantiiso"
#python merge_res.py -l ./res/ -P ST,TT,VJ,VV -c "muon,muonantiiso"
...
python new_singletop.py -c muonantiiso -s noSys --t3batch -f files/final/ -P ST,TT,VJ,VV -S 10
