...
#ST_Tbar_tch.sigma = 26.2278*3.85
ST_Tbar_tch.color = ROOT.kYellow -7
...
ST_Tbar_sch.sigma = 35.6
ST_Tbar_sch.jpref = jetLabel 
ST_Tbar_sch.jp = jetLabel
ST_Tbar_sch.color = ROOT.kYellow
ST_Tbar_sch.style = 1
...
ST_tch.style = 1
ST_tch.fill = 1001
ST_tch.leglabel = "Single Top, t-channel"
ST_tch.label = "ST_tch"
ST_tch.components = [ST_T_tch,ST_Tbar_tch]
#ST.components = [ST_Tbar_tW, ST_T_tW, ST_T_tch, ST_Tbar_tch]

ST_sch = sample()
ST_sch.color = ROOT.kYellow
ST_sch.style = 1
ST_sch.fill = 1001
ST_sch.leglabel = "Single Top, s-channel"
ST_sch.label = "ST_sch"
