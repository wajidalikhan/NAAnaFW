...
#include <iostream>
#include <math.h>
//#include "EventReco/interface/mt2bl_bisect.h
...
double mt2bl::get_mt2bl()
{
   ...
   //   if(entry_==58469) cout<<" solved "<< solved <<endl; 
           
   if (!solved) mt2bl_bisect();
   
   //   if(entry_==58469) cout<<" solved " << solved <<" "<< mt2bl_b <<endl; 
...
//      cout<<"call set mom " << El <<" "<< plx <<" "<<ply <<" "<<plz <<" "<< Eb1 <<" "<<pb1x <<" "<< pb1y<<" "<< pb1z <<" "<< Eb2 <<" "<< pb2x
// 	 <<" "<< pb2y <<" "<< pb2z <<" "<< pmissx <<" "<< pmissy <<endl; 
//    }
...
//    if(entry_==58469){
//      cout<<"check Eb " << Eb<<" "<< Ebsq <<" "<< Eb2*Eb2 <<" "<<  pb2z*pb2z <<endl; 
//      cout<<"chekcEb " << pbx*pbx+ pby*pby <<endl; 
//    }
...
//    if(entry_==58469){
//      cout<<"ma " << ma <<" "<< masq <<" mb " << mb <<" "<< mbsq <<endl; 
//    }
...
//    if(entry_==58469){
//      cout<<" nsols_high " << nsols_high <<endl; 
//    }
...
//    if(entry_==58469){
//      cout<<"  sqrt(Deltasq_high+mn1sq) - sqrt(Deltasq_low+mn1sq) " << sqrt(Deltasq_high+mn1sq) - sqrt(Deltasq_low+mn1sq) <<" preci " << precision <<endl; 
//    }
   ...
   //   if( entry_==58469 ) cout<<"final return " << mt2bl_b <<endl;
