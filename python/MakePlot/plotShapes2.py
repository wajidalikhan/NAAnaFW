...
# open file
ddqcd = TFile("DDQCD-Purity/DDQCD_muon.root")
ddqcdmcsub = TFile("output/muonantiiso/histos_lin/DDQCD_muonantiiso.root")
...
#ddqcd = TFile("res/test_ddqcd.root")
#ddqcdmcsub = TFile("res/test_ddqcdmcsub.root")
