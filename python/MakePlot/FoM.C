...
void FoM(){
  ...
  //TString var = "h_2j1t_MuPt";
  //TString var = "h_2j1t_mtwcut_MuPt";
  TString var = "h_2j1t_mtwcut_sr_MuPt";
  //TString var = "h_3j1t_mtwcut_MuPt";
  //TString var = "h_3j1t_MuPt";
  //TString var = "h_3j2t_MuPt";
  //TString var = "h_3j2t_mtwcut_MuPt";
  ...
  TFile *bkg1 = TFile::Open(path+"/"+"QCDMuEPt20toInf_muon.root");
